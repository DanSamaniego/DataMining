...
# Resumen
## Se indentifica las parroquias de la Provincia de Imbabura en donde existe mayor cantidad de personas con vivienda propia y arrendatarios haciendo uso de la herramienta RStudio, en primer lugar ocupa San Miguel de Ibarra seguido por Otavalo, en con un total de personas propietarias de 77.931 y 33.250 respectivamente y de personas arrendatarias con un total de 42.563 y 12.018 respectivamente.
...
## Mostrar graficamente el total de personas propietarias y arrendatarias.
```{r}
library(ggplot2)
